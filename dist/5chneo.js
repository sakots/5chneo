...
`)}function _(e){document.getElementById(m)?.remove();let t=document.createElement("div");t.id=m,t.innerHTML=`
    ...
    <style>
      ...
      #${a} .fivech-neo-mount { min-height: 470px; }
